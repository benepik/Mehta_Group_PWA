(function () {
  ...
  (self["webpackChunkMehta"] = self["webpackChunkMehta"] || []).push([["src_app_office_report_user-list_user-list_module_ts"], {
    ...
    /***/
    85772: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    20358: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      _UserListPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _user_list_routing_module__WEBPACK_IMPORTED_MODULE_0__.UserListPageRoutingModule],
    ...
    /***/
    14209: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _UserListPage = /*#__PURE__*/function () {
        function UserListPage(route, platform, zone, sendData, localStorage, apiService) {
        ...
        _createClass(UserListPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.localStorage.getStorage().then(function (storedData) {
              _this2.allStored = storedData.allStoreData;
              console.log('stored data in dealer list page', _this2.allStored);
          ...
          key: "reportShow",
          value: function reportShow() {
            var _this3 = this;

            this.zone.run(function () {
              var apiKey = {
                "request_user_type": _this3.allStored.employee_type,
                "search_str": "",
                "value": "",
                "request_for": _this3.allStored.user_id,
                "request_type": "list"
              };
              console.log('login data response', apiKey);

              _this3.apiService.apiCallWithLoginToken(src_assets_constant__WEBPACK_IMPORTED_MODULE_5__.URLS.getUserList, apiKey).subscribe(function (result) {
      ...
      _UserListPage = (0, tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_8__.Component)({
    ...
    /***/
    60988: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=src_app_office_report_user-list_user-list_module_ts-es5.js.map
                    ...
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        ...
                        this.apiService.apiCallWithLoginToken(src_assets_constant__WEBPACK_IMPORTED_MODULE_4__.URLS.ProductListUrl, apiKey).subscribe(function (result) {
                          ...
                          _this4.temparray = result;

                          if (result.success == 1) {
                            _this4.serverData = result.data;
                            _this4.errorImage = '';
                          } else {
                            _this4.errorImage = result.error_image; // this.apiService.showToastMessage(result.message, 'top', 3000, 'redBg');
                          }
                        }, function (err) {

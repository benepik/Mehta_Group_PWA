(function () {
  ...
  (self["webpackChunkMehta"] = self["webpackChunkMehta"] || []).push([["src_app_orderModule_appove-reject-reedemption_appove-reject-reedemption_module_ts"], {
    ...
    /***/
    57537: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "AppoveRejectReedemptionPageRoutingModule": function AppoveRejectReedemptionPageRoutingModule() {
          return (
            /* binding */
            _AppoveRejectReedemptionPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _appove_reject_reedemption_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./appove-reject-reedemption.page */
      2271);
      ...
      var _AppoveRejectReedemptionPageRoutingModule = function AppoveRejectReedemptionPageRoutingModule() {
        _classCallCheck(this, AppoveRejectReedemptionPageRoutingModule);
      };

      _AppoveRejectReedemptionPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    /***/
    74177: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "AppoveRejectReedemptionPageModule": function AppoveRejectReedemptionPageModule() {
          return (
            /* binding */
            _AppoveRejectReedemptionPageModule
          );
        }
        /* harmony export */
      ...
      var _appove_reject_reedemption_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./appove-reject-reedemption-routing.module */
      57537);
      /* harmony import */


      var _appove_reject_reedemption_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./appove-reject-reedemption.page */
      2271);

      var _AppoveRejectReedemptionPageModule = function AppoveRejectReedemptionPageModule() {
        _classCallCheck(this, AppoveRejectReedemptionPageModule);
      };

      _AppoveRejectReedemptionPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _appove_reject_reedemption_routing_module__WEBPACK_IMPORTED_MODULE_0__.AppoveRejectReedemptionPageRoutingModule],
    ...
    /***/
    2271: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "AppoveRejectReedemptionPage": function AppoveRejectReedemptionPage() {
          return (
            /* binding */
            _AppoveRejectReedemptionPage
          );
        }
        /* harmony export */
      ...
      var _raw_loader_appove_reject_reedemption_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./appove-reject-reedemption.page.html */
      11536);
      /* harmony import */


      var _appove_reject_reedemption_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./appove-reject-reedemption.page.scss */
      67465);
      /* harmony import */
      ...
      /*! src/assets/constant */
      56544); // import { ApiService } from '../provider/api.service';


      var _AppoveRejectReedemptionPage = /*#__PURE__*/function () {
        function AppoveRejectReedemptionPage(apiService, zone, route, location, sendData) {
          _classCallCheck(this, AppoveRejectReedemptionPage);
        ...
        _createClass(AppoveRejectReedemptionPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.orderDetail();
          }
          ...
          key: "orderDetail",
          value: function orderDetail() {
            var _this2 = this;

            this.apiService.presentLoadingDefault();
            this.zone.run(function () {
              var apiKey = {
                "order_id": _this2.priviousData.auto_id,
                "is_panel_login": ''
              };

              _this2.apiService.apiCallWithLoginToken(src_assets_constant__WEBPACK_IMPORTED_MODULE_4__.URLS.orderDetailUrl, apiKey).subscribe(function (result) {
                console.log("PostListUrl: ", result);

                _this2.apiService.presentLoadingClose();

                _this2.orderData = result;
          ...
          key: "acceptFun",
          value: function acceptFun(item) {
            var _this3 = this;

            this.apiService.presentLoadingDefault();
            this.zone.run(function () {
              var apiKey = {
                "order_id": _this3.priviousData.auto_id,
                "product_price": '',
                "agency_fees": '',
                "courier_charges": '',
              ...
              _this3.apiService.apiCallWithLoginToken(src_assets_constant__WEBPACK_IMPORTED_MODULE_4__.URLS.acceptRejectUrl, apiKey).subscribe(function (result) {
                console.log("PostListUrl: ", result);
        ...
        return AppoveRejectReedemptionPage;
      }();

      _AppoveRejectReedemptionPage.ctorParameters = function () {
        return [{
      ...
      _AppoveRejectReedemptionPage = (0, tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_5__.Component)({
    ...
    /***/
    11536: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=src_app_orderModule_appove-reject-reedemption_appove-reject-reedemption_module_ts-es5.js.map
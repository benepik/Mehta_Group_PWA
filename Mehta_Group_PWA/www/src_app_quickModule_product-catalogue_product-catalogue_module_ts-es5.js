        ...
        _createClass(ProductCataloguePage, [{
          ...
          value: function product_icon() {
            ...
            this.zone.run(function () {
              ...
              _this2.apiService.apiCallWithLoginToken(src_assets_constant__WEBPACK_IMPORTED_MODULE_5__.URLS.BrandProductUrl, apiKey).subscribe(function (result) {
                _this2.apiService.presentLoadingClose();

                if (result.success == '1' || result.success == '1') {
                  _this2.productBrand = result.data;
                }
              });
            });
          }

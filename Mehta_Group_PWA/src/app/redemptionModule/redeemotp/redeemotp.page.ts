...
export class RedeemotpPage implements OnInit {
  ...
  req:any;
  red: any;
  constructor(public modalController: ModalController,public apiServices:ApiService,public platform:Platform,private sendData: DataTransferService,public zone:NgZone,private router:Router) {

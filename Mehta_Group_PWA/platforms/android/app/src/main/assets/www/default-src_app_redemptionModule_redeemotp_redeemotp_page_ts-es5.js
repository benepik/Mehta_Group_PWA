(function () {
  ...
  (self["webpackChunkMehta"] = self["webpackChunkMehta"] || []).push([["default-src_app_redemptionModule_redeemotp_redeemotp_page_ts"], {
    ...
    26023: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      /*! @angular/router */
      39895); // import { HttpClient, HttpEvent, HttpEventType } from '@angular/common/http';


      var _RedeemotpPage = /*#__PURE__*/function () {
        function RedeemotpPage(modalController, apiServices, platform, sendData, zone, router) {
        ...
        _createClass(RedeemotpPage, [{
          ...
          value: function gotohistory() {
            ...
            this.zone.run(function () {
              return (0, tslib__WEBPACK_IMPORTED_MODULE_5__.__awaiter)(_this5, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
                var _this6 = this;
      ...
      _RedeemotpPage = (0, tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({

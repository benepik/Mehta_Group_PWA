...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_dealerModule_customer-allocation_customer-allocation_module_ts"), __webpack_require__.e("src_app_services_data-transfer_service_ts-_07560")]).then(__webpack_require__.bind(__webpack_require__, /*! ./dealerModule/customer-allocation/customer-allocation.module */ 71689)).then(m => m.CustomerAllocationPageModule)
    },
    {
    ...
    {
        path: 'orders',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_services_data-transfer_service_ts-_07561")]).then(__webpack_require__.bind(__webpack_require__, /*! ./orderModule/orders/orders.module */ 8844)).then(m => m.OrdersPageModule)
    },
    {
        path: 'orderdetails',
...
let AppComponent = class AppComponent {
    constructor(platform, localStorage, loc, zone, apiService, route, alertController, splashScreen, statusBar) {
    ...
    maintance() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__awaiter)(this, void 0, void 0, function* () {
            this.zone.run(() => {
                let apiKey = {};
                this.apiService.apiCallWithLoginToken(src_assets_constant__WEBPACK_IMPORTED_MODULE_2__.URLS.maintanceUrl, apiKey).subscribe((result) => (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__awaiter)(this, void 0, void 0, function* () {
...
AppComponent.propDecorators = {
    routerOutlets: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_11__.ViewChildren, args: [_ionic_angular__WEBPACK_IMPORTED_MODULE_9__.IonRouterOutlet,] }],
    outlet: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_11__.ViewChildren, args: [_angular_router__WEBPACK_IMPORTED_MODULE_7__.RouterOutlet,] }]
};
...
/* harmony import */ var _angular_service_worker__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @angular/service-worker */ 72249);
...
AppModule = (0,tslib__WEBPACK_IMPORTED_MODULE_11__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_12__.NgModule)({
        ...
        entryComponents: [],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_13__.BrowserModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_14__.IonicModule.forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_3__.AppRoutingModule, _angular_common_http__WEBPACK_IMPORTED_MODULE_15__.HttpClientModule,
            _ionic_storage_angular__WEBPACK_IMPORTED_MODULE_16__.IonicStorageModule.forRoot(), _angular_service_worker__WEBPACK_IMPORTED_MODULE_17__.ServiceWorkerModule.register('ngsw-worker.js', {
        ...
        providers: [
            ...
            _ionic_native_file_ngx__WEBPACK_IMPORTED_MODULE_6__.File, _ionic_native_file_transfer_ngx__WEBPACK_IMPORTED_MODULE_10__.FileTransfer,
...
let ApiService = class ApiService {
    constructor(http, loadingCtrl, toastController, localStorage) {
        this.http = http;
    ...
    apiCallWithLoginToken(url, data) {
        ...
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(this.localStorage.getStorage()).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeMap)((storedData) => {

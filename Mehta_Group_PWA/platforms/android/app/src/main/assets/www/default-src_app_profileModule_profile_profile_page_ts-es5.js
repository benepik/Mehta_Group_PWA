(function () {
  ...
  (self["webpackChunkMehta"] = self["webpackChunkMehta"] || []).push([["default-src_app_profileModule_profile_profile_page_ts"], {
    ...
    51270: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_services_local_storage_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! src/app/services/local-storage.service */
      18345);
      /* harmony import */


      var src_app_services_data_transfer_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      ...
      var _ProfilePage = /*#__PURE__*/function () {
        function ProfilePage(camera, actionSheetController, file, storage, router, platform, filePath, sendData, modalCtrl, popoverController, toastController, zone, apiService, alertController) {
        ...
        _createClass(ProfilePage, [{
          ...
          value: function profileShow() {
            ...
            this.zone.run(function () {
              ...
              _this2.apiService.apiCallWithLoginToken(src_assets_constant__WEBPACK_IMPORTED_MODULE_3__.URLS.SideMenuUrl, apiKey).subscribe(function (result) {
                console.log("SideMenuUrl: ", result);

                if (result.success == 1) {
                  _this2.profileData = result.data;
                } else {}
              }, function (err) {
                    ...
                    case 6:
                      ...
                      this.zone.run(function () {
                        if ((item === null || item === void 0 ? void 0 : item.redirect_url) == "logout") {
                          ...
                          if (_this3.profileData.emp_data.employee_type == "1") {
                            _this3.sendData.registrationType = {
                              "request_page": "account_detail"
                            };
                            _this3.sendData.alldata = _this3.profileData.emp_data.employee_type;
                            console.log('registrationType', _this3.sendData.registrationType);

                            _this3.router.navigate(['./registration']);
                          } else {
                            _this3.router.navigate(['./accounts-detail']);
                          }
                        } else {
                          _this3.router.navigateByUrl(item === null || item === void 0 ? void 0 : item.redirect_url);
                        }
                      });
          ...
          value: function LogOutFun() {
            ...
            this.zone.run(function () {
              ...
              _this5.apiService.apiCallWithLoginToken(src_assets_constant__WEBPACK_IMPORTED_MODULE_3__.URLS.LogOutUrl, apiKey).subscribe(function (result) {
                console.log('logout data response', result); // this.accountData=result.data.account_details;

                _this5.storage.remove('allStoreData');

                _this5.storage.getStorage().then(function (storedData) {
                        ...
                        switch (_context3.prev = _context3.next) {
                          case 0:
                            ...
                            if (!this.platform.is('mobile')) {
                              ...
                              }, 200); // this.appCtrl.getRootNav().setRoot(yourcomponent);
                  ...
                  switch (_context5.prev = _context5.next) {
                    case 0:
                      this.zone.run(function () {
                        ...
                        _this6.apiService.apiCallWithLoginToken(src_assets_constant__WEBPACK_IMPORTED_MODULE_3__.URLS.maintanceUrl, apiKey).subscribe(function (result) {
                          return (0, tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(_this6, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
                    ...
                    case 5:
                      ...
                      modal.onDidDismiss().then(function (dataReturned) {
                        ...
                        if (dataReturned !== null) {
                          _this8.UplaodData = dataReturned.data;
                          _this8.dataReturned = dataReturned.data.data; // this.currentObj.answer = this.dataReturned.data;

                          console.log(" this.dataReturned:", _this8.dataReturned); // this.userImg = this.dataReturned.data;

                          _this8.userImg = _this8.dataReturned.filebaseUrl;

                          if (_this8.userImg == undefined) {
                            _this8.userImg = '';
                          }
                        } else {
                          _this8.userImg = '';
      ...
      _ProfilePage = (0, tslib__WEBPACK_IMPORTED_MODULE_10__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_13__.Component)({

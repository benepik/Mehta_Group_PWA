    ...
    uploadImageonserver() {
        ...
        this.localStorage.getStorage().then(dataFromStorage => {
            ...
            let options = {
                ...
                params: {
                    'file': targetPath, "client_id": src_assets_constant__WEBPACK_IMPORTED_MODULE_3__.APP_CONFIG.clientId, "device": src_assets_constant__WEBPACK_IMPORTED_MODULE_3__.APP_CONFIG.device, "device_id": src_assets_constant__WEBPACK_IMPORTED_MODULE_3__.APP_CONFIG.device_id,

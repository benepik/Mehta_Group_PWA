            ...
            this.localStorage.getStorage().then(function (dataFromStorage) {
              ...
              var options = {
                ...
                params: {
                  ...
                  "device": src_assets_constant__WEBPACK_IMPORTED_MODULE_3__.APP_CONFIG.device,
                  "device_id": src_assets_constant__WEBPACK_IMPORTED_MODULE_3__.APP_CONFIG.device_id,
